          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-green-100 hover:text-white">Menu</a></li>
                <li><a href="#" className="text-green-100 hover:text-white">Promo</a></li>
                <li><a href="#" className="text-green-100 hover:text-white">Tentang Kami</a></li>
                <li><a href="#" className="text-green-100 hover:text-white">Kontak</a></li>
              </ul>
            </div>
