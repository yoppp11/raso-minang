  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await Swal.fire({
        icon: 'success',
        title: 'Berhasil!',
        text: 'Kategori baru berhasil diupdate',
        timer: 2000,
    ...
    try {
        ...
        if (response.data.data) {
            ...
            Swal.fire({
                ...
                text: 'Kategori dengan ID tersebut tidak ditemukan.',
            })
            navigate('/admin/category')
        }
  ...
  useEffect(()=> {
    if (id) {
      ...
      Swal.fire({
        ...
        text: 'Halaman ini tidak dapat diakses tanpa ID kategori yang valid.',
      })
      navigate('/admin/category')
    }
  }, [])
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Isi informasi kategori yang akan diubah
              </p>
            </div>
          </div>
        </div>
